...
```{r}
set.seed(42)
lm.iq = train(IQ.child ~ IQ.mother + IQ.father + n.siblings, data = iq_df, method = 'lm', trControl = trainControl(method = 'cv', number = 5))
```
...
lm.iq_2 = train(IQ.child ~ IQ.mother + IQ.father + n.siblings, data = iq_df_siblings, method = 'lm', trControl = trainControl(method = 'cv', number = 5))
summary(lm.iq_2)
```
