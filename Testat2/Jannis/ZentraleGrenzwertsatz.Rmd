...
hist1 = ggplot(df) +
  geom_histogram(aes(x = df[,1], fill='red', alpha = 0.5), binwidth = 0.25) +
  geom_histogram(aes(x = norm[,1], fill='blue', alpha = 0.5), binwidth = 0.25)
hist2 = ggplot(df) +
  geom_histogram(aes(x = df[,2], fill='red', alpha = 0.5), binwidth = 0.25) +
  geom_histogram(aes(x = norm[,1], fill='blue', alpha = 0.5), binwidth = 0.25)
hist3 = ggplot(df) +
  geom_histogram(aes(x = df[,3], fill='red', alpha = 0.5), binwidth = 0.25) +
  geom_histogram(aes(x = norm[,1], fill='blue', alpha = 0.5), binwidth = 0.25)
hist4 = ggplot(df) +
  geom_histogram(aes(x = df[,4], fill='red', alpha = 0.5), binwidth = 0.25) +
  geom_histogram(aes(x = norm[,1], fill='blue', alpha = 0.5), binwidth = 0.25)
hist5 = ggplot(df) +
  geom_histogram(aes(x = df[,5], fill='red', alpha = 0.5), binwidth = 0.25) +
  geom_histogram(aes(x = norm[,1], fill='blue', alpha = 0.5), binwidth = 0.25)
hist6 = ggplot(df) +
  geom_histogram(aes(x = df[,6], fill='red', alpha = 0.5), binwidth = 0.25) +
  geom_histogram(aes(x = norm[,1], fill='blue', alpha = 0.5), binwidth = 0.25)
