...
Wichtig: goal rausfiltern für Clustering! Auch bei PCA!
...
clustered_km = stats::kmeans(df_scaled, centers = 2, nstart=20)
```
...
```{r}
# Ihre Lösung:
df_transformed = fastDummies::dummy_columns(df[,-c(goal)], remove_selected_columns=TRUE)
