...
```{r}
# Ihre Lösung:
t.test(df[df$goal == 1,]$chol, df[df$goal == 0,]$chol, alternative = 'greater')
```

Da p = 0.068 ist, kann man sagen, dass erkrankte Menschen, mit hoher Wahrscheinlichkeit einen höheren Cholesterin-Wert haben als nicht erkrankte.
